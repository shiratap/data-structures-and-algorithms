...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a,b) => dictionary[a.dayOfWeek] > dictionary[b.dayOfWeek]); 
};
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a,b) => {
    if(a.start === b.start && dictionary[a.dayOfWeek] === dictionary[b.dayOfWeek]){
      return a.end > b.end;
    }
    else if(dictionary[a.dayOfWeek] === dictionary[b.dayOfWeek]){
      return a.start > b.start;
    }
    else{
      return dictionary[a.dayOfWeek] > dictionary[b.dayOfWeek]
    }
  })
};
